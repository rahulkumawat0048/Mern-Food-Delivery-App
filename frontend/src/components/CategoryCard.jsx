...
const CategoryCard = ({name , image , onClick}) => {
  return (
    <div className='w-[120px] h-[120px] md:w-[180px] md:h-[180px] rounded-2xl  border-[#ff4d2d] shrink-0 overflow-hidden cursor-pointer bg-white shadow-sm border-[1px] relative shadow-gray-200 hover:shadow-lg transition-shadow '
    onClick={()=>onClick()}
    >
